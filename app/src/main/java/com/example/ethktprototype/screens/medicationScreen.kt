...
fun MedicationScreen(
    ...
    LaunchedEffect(true) {
        viewModel.getMedicationStatements("Patient/019706de-81bf-77d0-a864-2db46cad1d8c")
    }
        ...
        Column(
            ...
            Column(
                ...
                if (medicationStatements.isEmpty()) {
                    Text("No regular medication.")
                } else {
                    MedicationList(medicationStatements)
                }
            }
        }
...
@Composable
fun MedicationList(medicationStatements: List<MedicationStatementEntity>) {
    LazyColumn(
        modifier = Modifier
            .fillMaxSize()
            .padding(16.dp)
    ) {
        items(medicationStatements) { medication ->
            ...
            Card(
                ...
                Column(
                    ...
                    if (isExpanded) {
                        ...
                        Text("Start: ${medication.start}")
                        Text("End: ${medication.end}")
                    }
                }
            }
        }
