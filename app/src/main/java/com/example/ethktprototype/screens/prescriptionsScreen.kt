...
fun PrescriptionsScreen(
    ...
    val medicationRequestsMap by viewModel.medicationRequests.collectAsState()
    val medicationRequests = medicationRequestsMap[patientId] ?: emptyList()
    ...
    Box(
        ...
        Column(
            ...
            if (uiState.isMedicationRequestsLoading) {
            ...
            Column(
                ...
                if (medicationRequests.isEmpty()) {
                    ...
                    PrescriptionList(medicationRequests)
                }
            }
        }
...
@Composable
fun PrescriptionList(medicationRequests: List<MedicationRequestEntity>) {
    LazyColumn(
        modifier = Modifier
            .fillMaxSize()
            .padding(16.dp)
    ) {
        items(medicationRequests) { medication ->
                ...
                Column(
                    ...
                    Row(
                        ...
                        Column(modifier = Modifier.weight(1f)) {
                            ...
                            Text(
                                text = "Authored On: ${medication.authoredOn}",
                    ...
                    if (isExpanded) {
                        ...
                        medication.dosage.split(",").forEach { dosage ->
                            Text("  - $dosage")
                        }
                    }
                }
